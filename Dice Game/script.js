...
btn.onclick = () => {
    ...
    if (player_1 == 0) {
        place_1.style.backgroundImage = "url('Image/one.png')";
        place_1.style.backgroundSize = "100% 100%";
        place_1.innerHTML = '';
    }
    else if (player_1 == 1) {
        place_1.style.backgroundImage = "url('Image/two.png')";
        place_1.style.backgroundSize = "100% 100%";
        place_1.innerHTML = '';
    }
    else if (player_1 == 2) {
        place_1.style.backgroundImage = "url('Image/three.png')";
        place_1.style.backgroundSize = "100% 100%";
        place_1.innerHTML = '';
    }
    else if (player_1 == 3) {
        place_1.style.backgroundImage = "url('Image/four.png')";
        place_1.style.backgroundSize = "100% 100%";
        place_1.innerHTML = '';
    }
    else if (player_1 == 4) {
        place_1.style.backgroundImage = "url('Image/five.png')";
        place_1.style.backgroundSize = "100% 100%";
        place_1.innerHTML = '';
    }
    else if (player_1 == 5) {
        place_1.style.backgroundImage = "url('Image/six.png')";
        place_1.style.backgroundSize = "100% 100%";
        place_1.innerHTML = '';
    }

    if (player_2 == 0) {
        place_2.style.backgroundImage = "url('Image/one.png')";
        place_2.style.backgroundSize = "100% 100%";
        place_2.innerHTML = '';
    }
    else if (player_2 == 1) {
        place_2.style.backgroundImage = "url('Image/two.png')";
        place_2.style.backgroundSize = "100% 100%";
        place_2.innerHTML = '';
    }
    else if (player_2 == 2) {
        place_2.style.backgroundImage = "url('Image/three.png')";
        place_2.style.backgroundSize = "100% 100%";
        place_2.innerHTML = '';
    }
    else if (player_2 == 3) {
        place_2.style.backgroundImage = "url('Image/four.png')";
        place_2.style.backgroundSize = "100% 100%";
        place_2.innerHTML = '';
    }
    else if (player_2 == 4) {
        place_2.style.backgroundImage = "url('Image/five.png')";
        place_2.style.backgroundSize = "100% 100%";
        place_2.innerHTML = '';
    }
    else if (player_2 == 5) {
        place_2.style.backgroundImage = "url('Image/six.png')";
        place_2.style.backgroundSize = "100% 100%";
        place_2.innerHTML = '';
    }
}
